...
"""print(json_example["text"])
print(json_example["created_at"])
print(json_example["entities"]["hashtags"][0]["text"])
print(json_example["id_str"])
print(json_example["in_reply_to_status_id"])
print(json_example["retweeted"])
print(json_example["retweet_count"])
print(json_example["in_reply_to_user_id_str"])
print(json_example["user"]['id'])"""
